                    ...
                    <div class="resource-block margin-bottom-large rh-setting">
                        <a href="https://www.nationalarchives.gov.uk/education/resources/telling-tommies-tales/">
                            <div class="has-background"
                                style="background-image: url(/wp-content/themes/tna/images/first-world-war/telling-tommies-tales.png)">
                            </div>
                        </a>
        ...
        <div class="col starts-at-full ends-at-one-third clr bg-colour box-shadow secondary">
            ...
            <div class="breather">
                ...
                <div class="grid-within-grid-two-item center">
                    <div>
                        <a href="https://www.flickr.com/photos/nationalarchives/sets/72157645788698678/"
                            title="External website - opens in new window" target="_blank">
                    ...
                    <div>
                        <a href="https://www.pinterest.com/uknatarchives/teaching-the-first-world-war/"
                            title="External website - opens in new window" target="_blank">
                            <div class="media-sprite icon-large-pinterest"></div>
                            <p class="media-sprite-text">Pinterest</p>
                        </a>
                    </div>
                </div>
                <div class="grid-within-grid-two-item center">
