...
<?php
    global $post;
    $showNewsletter = !has_category('hide-newsletter',$post->ID);
?>
...
<footer class="tna-footer">
    <div class="tna-container">
        ...
        <div class="tna-footer__navigation tna-column <?php if($showNewsletter) { ?>tna-column--width-1-2<?php } else { ?>tna-column--width-2-3<?php } ?> tna-column--full-medium tna-column--full-small tna-column--full-tiny tna-column--order-2 tna-column--order-4-medium tna-columns tna-columns--2 tna-columns--1-tiny">
