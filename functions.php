...
if (!function_exists('tna_dev_scripts')) :
	...
	wp_enqueue_script('tna-components', 'https://cdn.nationalarchives.gov.uk/react-components/dist/website-1.1.7.js', array(), '20200608', true);
...
// Redirection function - call in header.php or add_filter('template_redirect', 'redirect_if_404');
