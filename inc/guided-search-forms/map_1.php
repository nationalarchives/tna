<div class="research-guide-form">
	<form action="http://discovery.nationalarchives.gov.uk/results/r" method="get" name="searchform5532">
		<fieldset>
			<div class="field-row">
				<label for="Country or place">Country or place</label>
				<input id="Countryorplace" class="width-half" name="_q" />
			</div>
		</fieldset>
		...
		<input id="Hidden1" name="_cr1" type="hidden" value="FO 925" />
		<input id="Hidden2" name="_cr2" type="hidden" value="CO 700" />
		<input id="Hidden3" name="_cr3" type="hidden" value="WO 78" />
