<div class="research-guide-form">
	<form action="https://discovery.nationalarchives.gov.uk/results/r" method="get" name="searchform5532">
		<fieldset>
			<div class="field-row">
				<label for="Ship's official number">Ship's official number</label>
				<input id="Shipsofficialnumber" class="width-half" name="_q" />
			</div>
		</fieldset>
		...
		<input id="Hidden1" name="_cr1" type="hidden" value="BT 99" />
		<input id="Hidden2" name="_cr2" type="hidden" value="BT 380" />
		<input id="Hidden3" name="_cr3" type="hidden" value="BT 381" />
