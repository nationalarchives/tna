        ...
        <form action="http://discovery.nationalarchives.gov.uk/results/r" method="get" name="searchform5532">
                <fieldset>
                        <div class="field-row">
                                ...
                                <input id="Shipsname" class="width-half" name="_q" />
                        </div>
                </fieldset>
                ...
                <input id="Hidden10" name="_ser" type="hidden" value="ADM 115" />
                <input id="Hidden11" name="_ser" type="hidden" value="ADM 117" />
                <input id="Hidden12" name="_ser" type="hidden" value="ADM 119" />
                <input id="Hidden13" name="_hb" type="hidden" value="tna" />
        </form>
</div>