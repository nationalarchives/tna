<div class="research-guide-form">
	<form action="http://discovery.nationalarchives.gov.uk/results/r" method="get" name="searchform5532">
		<fieldset>
			<div class="field-row">
				<label for="Name of school or town">Name of school or town</label>
				<input id="Nameofschoolortown" class="width-half" name="_q" />
			</div>
		</fieldset>
		...
		<input id="Hidden1" name="_cr1" type="hidden" value="ED 21" />
		<input id="Hidden2" name="_cr2" type="hidden" value="ED 35" />
		<input id="Hidden3" name="_cr3" type="hidden" value="ED 161" />
