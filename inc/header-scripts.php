...
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/scripts/selectivizr-min.js"></script>
...
<!-- iOS viewport fix -->
<script src="<?php bloginfo('template_url'); ?>/scripts/ios-viewport-fix.js"></script>