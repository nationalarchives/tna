...
$glossaryDefinitions = array(
	...
	'alkali-works' => 'Place where Alkali manufacturing takes place.',
	'answers1' => 'The defendant\'s responses to the bill of complaint raised by the plaintiffs.',
	...
	'asbestos' => 'Material known to cause serious breathing related health issues.',
	'assignments' => 'Agreement between copyright holder and maker of work.',
	...
	'bioaccumulate' => 'A build up of substances such as pesticides or other chemicals in humans or animals.',
	'boolean-search1' => 'A Boolean search combines words and phrases using AND, OR, NOT to limit, broaden, or define the search.',
	'born-digital1' => 'Created in a digital format as opposed to converted to a digital format following the initial paper or analogue original.',
	'british-control-commission1' => 'British Control Commission was responsible for administering the British zone largely in Germany and Austria.',
	...
	'cinemagazine1' => 'A short film made up of informative stories and interviews, often about aspects of everyday life.',
	...
	'close-rolls1' => 'Chancery documents sealed or \'closed\' to ensure confidentiality, recording a wide range of government business.',
	...
	'con1' => 'A legal term from the Latin contra, meaning against.',
	...
	'control-commision1' => 'Control Commissions were established by the Allies and were responsible for administering their zones in the defeated Axis countries.',
	...
	'copyright' => 'Legal right that protects the use of a work once it has been published or protected by the legal process.',
	'cordite' => 'A type of explosive.',
	...
	'denization1' => 'The granting of residence in a country along with some rights of citizenship, such as the protection of the law.',
	'denizens1' => 'Foreigners allowed certain rights in their adopted country.',
	'department-code' => 'The letters at the start of a National Archives reference that show which department created the record. Some are initials such as HO for Home Office, others are not as obvious.',
	...
	'deponent1' => 'An individual providing evidence under oath in legal suits.',
	...
	'dominions1' => 'Semi-autonomous countries in the British Empire, including Canada, Australia, New Zealand and South Africa.',
	...
	'first-civil-war' => 'From August 1642 –July 1646.',
	'flax-factories' => 'Factories used to make flax, a material used to produce a variety of goods such as textiles.',
	...
	'gun-emplacement' => 'Military installation consisting of a prepared position for weapons.',
	'guncotton' => 'Used in gunpowder and bullets.',
	...
	'italic' => 'The italic hand is a handwriting style which originated in Italy and is more similar in style to modern handwriting.',
	'item1' => 'A level in our catalogue hierarchy. Smaller than a \'piece\', an item can be a page, a folder or a bundle of papers and is usually identified by a reference containing two forward slashes.',
	...
	'legacy-duty' => 'Tax on all legacies and residues of personal property (other than leaseholds) in wills and administrations.',	
	...
	'manuscript-lists' => 'Handwritten lists.',
	...
	'membrane1' => 'A prepared piece of parchment stitched at both ends to other leaves of parchment above and below.',
	...
	'metalliferous-mines' => 'Mines where metals are extracted.',
	'metallurgical' => 'The way in which medals are extracted in manufacturing.',
	...
	'name-followed-by-nat' => 'For example, Michael Marks nat*',
	'name-followed-by-reg' => 'For example, Raj Mohammed reg*',
	...
	'ordnance-factories1' => 'Government owned armament and munition factories.',
	...
	'patent-rolls1' => 'Chancery documents, issued publically, usually recording the granting of a right, a title or some other bestowment.',
	...
	'piece1' => 'A level in our catalogue hierarchy, within a series. Usually the level at which a reference becomes an orderable or viewable record. A piece can be a folder, file, volume or box of documents and is usually identified by a reference with a single forward slash.',
	'pieces1' => 'Piece - a level in our catalogue hierarchy, within a series. Usually the level at which a reference becomes an orderable or viewable record. A piece can be a folder, file, volume or box of documents and is usually identified by a reference with a single forward slash.',
	'pipe-roll1' => 'The annual financial accounts of local officials audited and recorded by the Exchequer on rolls of parchment.',
	'plaintiff1' => 'The person or party who raises a complaint and brings a case to a court of law.',
	...
	'protections1' => 'A form of legal protection of soldiers’ property whilst away on campaign.',
	...
	'record-series-reference' => 'The two part National Archives reference that identifies a series (group) of records from a particular government department; such as WO 95 or HO 144.',
	...
	'restoration' => '5 May 1660.',
	'revisionary-registers' => 'Registers containing retrospective legacy duty claims, 1812 to 1852.',
	...
	'secretary' => 'The secretary hand is a flowing style of handwriting commonly used in the early modern period.',
	...
	'series1' => 'A grouping of records held by The National Archives within a department, based on common function or subject.',
	...
	'stationers-hall' => 'Place where Stationer\'s Company is based',
	...
	'succession-duty' => 'Tax on transferred freehold and leasehold property after death.',
	...
	'villeinage1' => 'A feudal convention in which unfree peasants (villeins) were entitled to farm and live on land in exchange for providing their labour and other services to the owner of the land.',
	'wapentake1' => 'A division of land, smaller than a county.',
	'war-diaries1' => 'War diaries were official records kept by individual units detailing their daily activities during wartime.',
