<?php
/*
Template Name: Research guidance
*/
  ...
  <div class="row">
   ...
   <div class="col starts-at-full ends-at-two-thirds clr"> 
              ...
              <?php the_content(); ?>
                   ...
                   <ul id="a-z-menu">
        <li <?php if ($strletter == "a"){ echo ("class=selected"); }?>><a href="/records/research-guidance/?letter=a">A</a></li>
...
<option value="" >Filter by...</option>
        <optgroup label="Keywords starting with <?php echo (strtoupper($strletter));?> ">
    <!-- <ul class="link-list">-->
...
<?php echo ("Keywords: "); $posttags = get_the_tags();
if ($posttags) {
